...
// ZaloMulti
//
// Color tokens và extensions cho Light/Dark mode.
...
extension Color {
    static let avatarGradients: [(Color, Color)] = [
        (Color(hex: "#007AFF"), Color(hex: "#5E5CE6")),  // Blue-Indigo
        (Color(hex: "#30D158"), Color(hex: "#34C759")),  // Green
        (Color(hex: "#FF6B35"), Color(hex: "#FF9500")),  // Orange
        (Color(hex: "#BF5AF2"), Color(hex: "#AF52DE")),  // Purple
        (Color(hex: "#FF3B30"), Color(hex: "#FF6B6B")),  // Red
        (Color(hex: "#5AC8FA"), Color(hex: "#007AFF")),  // Cyan-Blue
        (Color(hex: "#FF9500"), Color(hex: "#FFCC00")),  // Amber
        (Color(hex: "#64D2FF"), Color(hex: "#5AC8FA")),  // Light Blue
    ]
